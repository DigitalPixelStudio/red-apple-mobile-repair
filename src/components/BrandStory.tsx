    ...
    <section className="section-apple relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[800px] px-6 text-center lg:px-8">
        <Reveal>
          ...
          <h2 className="section-title font-apple text-white mt-3">Nine years of<br/>fixing what <span className="gradient-text">matters.</span></h2>
          <div className="mt-8 space-y-4 font-apple text-[16px] leading-[1.8] text-[#86868b]">
            <p>
              Red Apple started in 2015 as a small repair counter near Halasuru Metro. Today, we&apos;re one of Bangalore&apos;s most trusted iPhone repair studios — with over <span className="font-semibold text-white">10,000 devices repaired</span> and a <span className="font-semibold text-white">4.9/5 rating from 905+ customers</span>.
            </p>
            <p>
          ...
          <div className="mt-10 flex items-center justify-center gap-3">
            <span className="rounded-full bg-white/[0.04] px-5 py-2 text-[13px] font-medium text-[#86868b]">📍 Halasuru, Bengaluru</span>
            <span className="rounded-full bg-white/[0.04] px-5 py-2 text-[13px] font-medium text-[#86868b]">🗓️ Since 2015</span>
            <span className="rounded-full bg-white/[0.04] px-5 py-2 text-[13px] font-medium text-[#86868b]">⭐ 4.9/5</span>
          </div>
        </Reveal>
      </div>
    </section>
