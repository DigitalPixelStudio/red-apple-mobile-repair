...
export default function StickyCta() {
  ...
  return (
    <div className={`fixed inset-x-0 bottom-0 z-40 transition-transform duration-500 lg:hidden ${show ? "translate-y-0" : "translate-y-full"}`}>
      <div className="mx-3 mb-3 grid grid-cols-3 gap-2 rounded-[22px] border border-white/[0.08] bg-[#0a0a0a]/90 p-2 shadow-2xl backdrop-blur-xl">
        <a href={SITE.phoneHref} className="flex flex-col items-center justify-center gap-1 rounded-2xl bg-white/[0.04] py-3 text-white">
        ...
        <a href="#selector" className="flex flex-col items-center justify-center gap-1 rounded-2xl bg-gradient-to-r from-[#ff2d55] to-[#ff9500] py-3 text-white shadow-lg shadow-[#ff2d55]/20">
        ...
        <a href={wa("Hi Red Apple! 🍎")} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center gap-1 rounded-2xl bg-[#30d158]/90 py-3 text-white">
