    ...
    <section className="section-apple">
      <div className="mx-auto max-w-[1200px] px-6 lg:px-8">
        <Reveal className="text-center">
          ...
          <h2 className="section-title font-apple text-[#1d1d1f] mt-3">Make it <span className="gradient-text">last longer.</span></h2>
        ...
        <div className="mt-14 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {TIPS.map((t, i) => (
            <Reveal key={t.title} delay={i * 60} className="glass-card rounded-[24px] p-6">
              ...
              <h3 className="mt-3 font-apple text-[15px] font-bold text-[#1d1d1f]">{t.title}</h3>
